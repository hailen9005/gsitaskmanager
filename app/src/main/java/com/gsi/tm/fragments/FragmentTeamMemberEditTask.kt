...
import com.gsi.tm.presenters.FmEditTeamMemberVP
import kotlin.reflect.KClass

class FragmentTeamMemberEditTask : BaseFragment(), ContractTeamMemberEditGSI.MView {
    var rootView: View? = null
    var imvState: ImageView? = null
    var tvState: TextView? = null
    var presenter: ContractTeamMemberEditGSI.Presenter? = null
    ...
    override fun onCreateView(
        ...
        context?.let { cntx ->
            presenter = FmEditTeamMemberVP(cntx)
